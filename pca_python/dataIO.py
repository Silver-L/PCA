...
# generate path
def generate_path(dirin, outpath, case_list, extension='_A.mhd'):
    data_path = []
    case_list = load_list(case_list)
    for i in case_list:
        data_path.append(os.path.join(dirin, i) + extension)
    write_list(data_path, outpath)
    return outpath
